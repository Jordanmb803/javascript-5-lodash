...
const myEmployeesAddresses = _.map(myEmployees, (employee, index) => {
...
const myEmployeesAges = _.map(myEmployees, (employee) => {
  return employee.age;
...
const listToSendEmailsTo = _.union(breeFriendsEmails, bobFriendsEmails);
// console.log(listToSendEmailsTo) // Put lodash here to make list of the union of the two address.
